    ...
    internal class Pardonare : ICommand
    {
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            if (arguments.Count != 0)
            {
                ...
                string[] IpBansTxt = File.ReadAllLines(@"C:\Users\costin\AppData\Roaming\SCP Secret Laboratory\config\" + Server.Port + @"\IpBans.txt");
                string[] IdBansTxt = File.ReadAllLines(@"C:\Users\costin\AppData\Roaming\SCP Secret Laboratory\config\" + Server.Port + @"\UserIdBans.txt");
